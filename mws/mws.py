...
class DictWrapper(object):
    ...
    as a tree of ObjectDicts, stored in the .parsed property.
    """
    ...
    @property
    def parsed(self):
        """Provides access to the parsed contents of an XML response
        as a tree of ObjectDicts.
        """
        if self._rootkey:
...
class DataWrapper(object):
    ...
    def parsed(self):
        """
        Similar to the `parsed` property of DictWrapper,
        this provides a similar interface for a data response
    ...
    def unzipped(self):
        """
        If the response is comprised of a zip file,
        returns a ZipFile object of those file contents.
